...
1. Bagaimana merekomendasikan film yang relevan kepada pengguna hanya berdasarkan metadata film (_tanpa data interaksi_)?
...
1. **Konsistensi Genre**:
   ...
   - Film seperti _Guardians of the Galaxy_ dan _The Avengers_ memiliki kesamaan kuat pada genre Science Fiction

2. **Variasi Tema**:

   - Mencakup tema petualangan epik (_Pirates of the Caribbean_)
   - Teknologi futuristik (_Terminator Genisys_)
   - Dunia fantasi (_Deadpool_)
